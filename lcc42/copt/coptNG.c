...
//20-07-24 coptNG trying to improve COPT with limited liveness test
#include <ctype.h>
#include <stdio.h>
#define HSIZE 107
#define MAXLINE 100

int debug = 0, verbose=1; //debug and verbose flags
...
int main(argc, argv) int argc; char **argv; {
        ...
        for (i = 1; i < argc; i++)
                if (strcmp(argv[i], "-v") == 0){//dec 7
                        verbose = 1;
        				fprintf(stderr,"Copt peephole optimizer 2b2: \n");
				}
