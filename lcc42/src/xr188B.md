...
consm: CNSTU1 "%a" range (a,1,2)
consm: CNSTI1 "%a" range (a,1,2)
...
con8bit: CNSTI1 "%a" range (a,1,255)
con8bit: CNSTU1 "%a" range (a,1,255)
con: CNSTI1  "%a"
con: CNSTU1  "%a"
con: CNSTI2  "%a"
con: CNSTU2  "%a"
...
acon: con     "%0"
acon: ADDRGP2 "%a"
addr: ADDI1(reg,acon)  "'O',R%0,(%1)"
addr: ADDI2(reg,acon)  "'O',R%0,(%1)"
addr: ADDU1(reg,acon)  "'O',R%0,(%1)"
...
reg: DIVI1(reg,reg)  "\tCcall _divi2\n"   1
...
reg: MULU1(reg,reg)  "\tCcall _mulu2; MULU1(reg,reg) ******\n"   2
...
reg: ADDI1(reg,reg)   "\talu8b R%c,R%0,R%1,add; ADDI1(r,r)\n"  10
...
reg: ADDU1(reg,reg)   "\talu8b R%c,R%0,R%1,add; ADDU1(r,r)\n"  2
...
reg: BANDI1(reg,reg)  "\talu8b R%c,R%0,R%1,and; **8bit**\n"   1
...
reg: SUBI1(reg,reg)   "\talu8b R%c,R%0,R%1,sm,smb; **8bit**\n"  1
...
reg: SUBU1(reg,reg)   "\talu8b R%c,R%0,R%1,sm; SUBU1(r,r)\n"  2

reg: ADDI1(reg,con)   "\talu8bI R%c,R%0,%1,adi; ADDI1(reg,con)\n"  2
...
reg: SUBI1(reg,con)   "\talu8bI R%c,R%0,%1,smi\n"  1
...
reg: SUBU1(reg,con)   "\talu8bI R%c,R%0,%1,smi\n"  1
...
reg: NEGI1(reg)   "\tnegI2 R%c,R%0 ;NEGI1***************"  1
...
stmt: EQI1(reg,reg)  "\tjeqI1 R%0,R%1,%a; EQI2(reg,reg)\n"   2
stmt: EQI2(reg,reg)  "\tjeqI2 R%0,R%1,%a; EQI2(reg,reg)\n"   2
stmt: EQU2(reg,reg)  "\tjeqI2 R%0,R%1,%a;EQU2(reg,reg)\n"   2
stmt: EQU1(reg,reg)  "\tjeqI1 R%0,R%1,%a;EQU1(reg,reg)\n"   2
stmt: GEI1(reg,reg)  "\tjcI1 R%0,R%1,lbdf,%a; GE is flipped test from LT\n"   2
stmt: GEI2(reg,reg)  "\tjcI2 R%0,R%1,lbdf,%a; GE is flipped test from LT\n"   2
stmt: GEU1(reg,reg)  "\tjcU1 R%0,R%1,lbdf,%a; GE is flipped test from LT\n"  2
...
stmt: GTI1(reg,reg)  "\tjcI1 R%1,R%0,lbnf,%a ;GT is reversed operands from LT **8bit**\n"   2
...
stmt: LEI1(reg,reg)  "\tjcI1 R%1,R%0,lbdf,%a ;LE is flipped test & operands\n"  2
stmt: LEI2(reg,reg)  "\tjcI2 R%1,R%0,lbdf,%a ;LE is flipped test & operands\n"  2
stmt: LEU1(reg,reg)  "\tjcU1 R%1,R%0,lbdf,%a ;LE is flipped test & operands\n"  2
...
stmt: LTI1(reg,reg)  "\tjcI1 R%0,R%1,lbnf,%a; LT=lbnf i.e. subtract B from A and jump if borrow **8bit**\n"   2
...
stmt: NEI1(reg,reg)  "\tjneU1 R%0,R%1,%a; NEI1 weight=2\n"   2
stmt: NEI2(reg,reg)  "\tjneU2 R%0,R%1,%a; NEI2\n"   2
stmt: NEU1(reg,reg)  "\tjneU1 R%0,R%1,%a; NEU1 weight=1\n"   2
stmt: NEU2(reg,reg)  "\tjneU2 R%0,R%1,%a; NEU2\n"   2
...
stmt: GEI1(reg,con)  "\tjcI1I R%0,%1,lbdf,%a; GE is flipped test from LT J2021-1-30.1\n"   1
...
stmt: LTI1(reg,con)  "\tjcI1I R%0,%1,lbnf,%a  ;LTI2=lbnf **8bit**\n"   1
...
stmt: NEI1(reg,con0) "\tjnzU1 R%0,%a; NE 0 \n"   1 
stmt: NEU1(reg,con0) "\tjnzU1 R%0,%a; NE 0 \n"   1 
