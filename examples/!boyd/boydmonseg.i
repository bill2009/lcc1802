...
;so if there's an interrupt in mid calculation the sp will be pointing to free memory
        ...
        smi 10&255 ;claculate new low byte
        plo memAddr     ;save it for a moment
        ghi sp          ;grab high byte
        smbi (10>>8)&255 ;calculate the new page
...
$$nxt:  glo     retVal
        ...
        ghi     retVal
        lbz     $$done
$$go:   lda     R8             ;get byte to move - nb, R8 reg altered
        str     R11             ;place in dest 
        inc     R11             ;advance target ptr - nb dest reg altered
