...
@c:\lcc42\bin\lcc.exe "-target=xr18CX" "-Wf-volatile" "-Wf-g,;" -DRES=32 -DVIDMEM=0x7F00 -D__VIP__ -S %6 %7 %1.c 
...
@c:\lcc42\bin\asw -cpu %cpu%  -quiet -x -i c:\lcc42\include -L -D LCCPX=1 %1.basm
