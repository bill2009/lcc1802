...
void shapechar(shapelocation, lines_character, color_number);
void shapecolor(character, number, color);
void textcolordefinition(definition);
void monochrome(mono);
#else
void setcolor(colormem, color);
